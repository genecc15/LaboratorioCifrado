...
//        public static void CesarAlgoritmo(string Rpath, string Wpath, string Wpath2, string llave)
//        {
...
//        public static void Comprimir (string Rpath, string Wpath, string Wpath2, string llave)
//        {
